...
function Users(props) {
	const { element, setChatuser, setShowChat } = props;
	...
	useEffect(() => {
		const unsubscribe = onSnapshot(
			query(
				collection(db, "conversations", element.uid, "messages"),
	...
	return (
		<>
			<div
				className='activelink card p-1 bg-slate-700 dark:bg-gray-500 cursor-pointer my-1'
				onClick={() => {
				...
				<div className='user'>
					<div className='relative'>
						...
						<span
							className={`bottom-3 left-7 absolute  w-3.5 h-3.5 ${
