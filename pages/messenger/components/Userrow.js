...
function Userrow (props) {
  ...
  const pattern = new RegExp('\\b' + keyword.replace(/[\W_]+/g,""), 'i')
    ...
    const { setChatuser, chatuser, convos, fetchMore } = props 
    ...
    <h3 className="text-md font-semibold mt-12">ChatList</h3>
     <div className="search abs">
       <input type="text" placeholder='Search' 
         ...
         className='placeholder-gray-400 text-gray-600 bg-gray-100 rounded-full w-full py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent'
       />
