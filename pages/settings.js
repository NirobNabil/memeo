...
export default function Settings() {
  ...
  useEffect(() => {
    if(user){
      const q = query(collection(db, 'memes', user.uid, 'Trash'), orderBy('deletedAt', 'desc'))
  ...
  return (
    <>
    <div className="absolute top-0 left-0 z-5  p-2">
      <button onClick={() => router.back()} className="p-2  rounded-full shadow-md  focus:outline-none  dark:hover:bg-transparent dark:hover:text-gray-100 hover:bg-gray-100 hover:text-gray-900 bg-gray-100 text-gray-900 dark:bg-transparent dark:text-gray-100">
        <ArrowBack />
      </button>
    </div>
    <div className='bg-white dark:bg-slate-800'>
        ...
        <div className='bg-white dark:bg-slate-800 overflow-hidden shadow rounded-lg divide-y divide-gray-200 dark:divide-slate-700'>
          ...
          <div className='px-4 py-5 sm:p-0'>
            <dl className='sm:divide-y sm:divide-gray-200 dark:divide-slate-700'>
              ...
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 px-4'>
                <dt className='text-sm font-medium text-gray-500 dark:text-gray-400'>Photo</dt>
          ...
          <div className='px-4 py-5 sm:p-0'>
            <dl className='sm:divide-y sm:divide-gray-200 dark:divide-slate-700'>
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 px-4'>
                ...
                <dd className='mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2'>English</dd>
              </div>
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4  px-4'>
                <dt className='text-sm font-medium text-gray-500 dark:text-gray-400'>Time Zone</dt>
                <dd className='mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2'>{Intl.DateTimeFormat().resolvedOptions().timeZone}</dd>
              </div>
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4  px-4'>
                <dt className='text-sm font-medium text-gray-500 dark:text-gray-400'>Auto updates</dt>
                <dd className='mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2'>On</dd>
              </div>
            </dl>
          </div>
        </div>
      ...
      <div className='max-w-7xl mx-auto py-6 sm:px-6 lg:px-8'>
        <div className='bg-white dark:bg-slate-800 overflow-hidden shadow rounded-lg divide-y divide-gray-200 dark:divide-slate-700'>
          <div className='px-4 py-5 sm:px-6'>
            <h3 className='text-lg leading-6 font-medium text-gray-900 dark:text-white'>Update Password</h3>
            <p className='mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400'>
          ...
          <div className='px-4 py-5 sm:p-0'>
            <dl className='sm:divide-y sm:divide-gray-200 dark:divide-slate-700'>
              ...
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4  px-4'>
                <dt className='text-sm font-medium text-gray-500 dark:text-gray-400'>New Password</dt>
                <dd className='mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2'>
                  <input
                    type={showPassword ? 'text' : 'password'}
                    className='w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 dark:placeholder-gray-500 dark:bg-slate-700 p-2'
                  ...
                  />
                  <span className='text-xs text-gray-500 dark:text-gray-400'>Password must be at least 6 characters</span>
                </dd>
              </div>
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4  px-4'>
                <dt className='text-sm font-medium text-gray-500 dark:text-gray-400'>Confirm Password</dt>
                <dd className='mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2'>
                  <input
                    type={showPassword ? 'text' : 'password'}
                    className='w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm placeholder-gray-400 dark:placeholder-gray-500 dark:bg-slate-700 p-2'
              ...
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4  px-4'>
                ...
                <dd className='mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2'>
                  ...
                  />
                  <span className='text-xs text-gray-500 dark:text-gray-400 ml-2 '>Show password</span>
                </dd>
              </div>
      ...
      <div className='max-w-7xl mx-auto py-6 sm:px-6 lg:px-8'>
        <div className='bg-white dark:bg-slate-800 overflow-hidden shadow rounded-lg divide-y divide-gray-200 dark:divide-slate-700'>
          ...
          <div className='px-4 py-5 sm:p-0'>
            <dl className='sm:divide-y sm:divide-gray-200 dark:divide-slate-700'>
              <div className='py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4  px-4'>
                <dt className='text-sm font-medium text-gray-500 dark:text-gray-400'>Delete Account</dt>
                <dd className='mt-1 text-sm text-gray-900 dark:text-white sm:mt-0 sm:col-span-2'>
                  <button
                    onClick={() => {
                      setOpen2(true);
      ...
      <div className='mx-10 my-10 rounded-lg shadow-lg p-10'>
        <h1 className='text-2xl font-bold'>Trash Template ({trashs.length})</h1>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
          {trashs?.map(trash => (
            <div key={trash.id} className='bg-white dark:bg-slate-800 rounded-lg shadow-lg p-4'>
              {trash?.type === 'image' ? (
              <img src={trash.memeURL} alt={trash.name} className='w-full h-64 object-cover rounded-lg' />
              ) : (
                <video src={
                  trash.memeURL
                } className='w-full h-64 object-cover rounded-lg' controls />
              )}
     ...
     <Modal
      ...
      >
        <div className='bg-white dark:bg-slate-800 rounded-lg shadow-lg p-10'>
          <h1 className='text-2xl font-bold'>Are you sure you want to restore this template?</h1>
            ...
            <button
              onClick={async () => {
                if(trash){
                  ...
                  await deleteDoc(doc(db, 'memes', user.uid, 'Trash', trash.id));
        ...
        <div className='bg-white dark:bg-slate-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4'>
          <div className='sm:flex sm:items-start'>
            <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
              <h3 className='text-lg leading-6 font-medium text-gray-900 dark:text-white' id='modal-modal-title'>
                Delete Account
              </h3>
              <div className='mt-2'>
                <p className='text-sm text-gray-500 dark:text-gray-400' id='modal-modal-description'>
