...
const Terms = () => {
  return (
    ...
    //     <p className="fontsize-sm">&copy;Copyright memex 2022</p>
    //   </div>
    // </Container>
        ...
        <div className="col-12">
          <div className="terms">
            <div className="terms__header">
              <h1 className="terms__header--title">Terms of Service</h1>
              <p className="terms__header--date">Last updated: 2021-10-10</p>
            </div>
            <div className="terms__content">
              <p>
                Please read these Terms of Service ("Terms", "Terms of Service")
                carefully before using the https://memex.vercel.app website (the
                "Service") operated by Memex ("us", "we", or "our").
              </p>
              <p>
              ...
              <p>
                ...
                password, whether your password is with our Service or a third-
                party service.
              </p>
              <p>
              ...
              <p>
                ...
                that are not owned or controlled by Memex.
              </p>
              <p>
                Memex has no control over, and assumes no responsibility for, the
                content, privacy policies, or practices of any third party web
                sites or services. You further acknowledge and agree that Memex
