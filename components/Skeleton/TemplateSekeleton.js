...
export default function TemplateSekeleton() {


  return (
        <div role="status" className="flex justify-center items-center max-w-sm h-[250px] w-[220px] bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700">
