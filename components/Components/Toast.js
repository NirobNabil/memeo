...
export function ToastInfo({data}) {
    return (
        <div id="toast-notification" className="p-4 w-full min-w-[320px]  text-gray-900 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-300 transition-all duration-300 ease-in-out" role="alert">
